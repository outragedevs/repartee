        ...
        with (temporary / "server.log").open("w+") as log:
            try:
                ...
                if args.test_filter == "pinned_bouncer_":
                    test_args += " --skip pinned_bouncer_presence --skip pinned_bouncer_network_management --skip pinned_bouncer_setname --skip pinned_bouncer_monitor --skip pinned_bouncer_no_monitor --skip pinned_bouncer_invites --skip pinned_bouncer_names --skip pinned_bouncer_channel_context"
