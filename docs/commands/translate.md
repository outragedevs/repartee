...
The AI backend accepts English, German, Polish, French, Spanish and Mandarin
Chinese. Their ISO 639-1 and ISO 639-3 codes are accepted, including regional
forms such as `fr-FR` and `zh_CN`. Any other code is refused before conversation
